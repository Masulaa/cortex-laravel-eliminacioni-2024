...
<div class=" bg-gray-800 h-screen flex flex-col justify-center items-center">
    <form class=" pb-5 px-5 w-[50rem]" method="POST" action="{{ route('post.store') }}" enctype="multipart/form-data">
        @csrf
        <div class="mt-10 grid gap-6 mb-6 lg:grid-cols-2">
            <div>
            ...
            <div class="w-full mb-4 bg-gray-700 border border-gray-600 rounded-lg">
                    ...
                    <div class="flex items-center space-x-1">
                        ...
                        <button type="button"
                            ...
                            <svg class="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                ...
                                <path
                                    d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5ZM13.5 6a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3Zm-7 0a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3Zm9.071 8.03a5.5 5.5 0 0 1-8.142 0 1 1 0 1 1 1.414-1.414 3.5 3.5 0 0 0 5.314 0 1 1 0 1 1 1.414 1.414Z" />
                            </svg>
                ...
                <div class="px-4 py-2 bg-gray-800 rounded-b-lg">
                    ...
                    <div id="image-preview" class="flex items-center justify-center w-full h-40">
                        <img src="" id="preview-img" class="img-fluid mt-2 hidden" width="150">
                    </div>
                </div>
            </div>
        </div>
...
<!-- Add the JavaScript for image preview -->
<script>
